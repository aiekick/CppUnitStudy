...
protected:
    static thread_local AssertionRecorder* mp_assertionRecorder;
...
public:
    ...
    virtual void setUp() {
        mp_assertionRecorder = new AssertionRecorder();
    }

    //! Clean up after the test run.
    virtual void tearDown() {
        if (mp_assertionRecorder != nullptr) {
           throw mp_assertionRecorder->createException();
        }
    }

    static AssertionRecorder& getRecorder() {
        return *mp_assertionRecorder;
    }
};
